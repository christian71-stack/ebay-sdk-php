...
The SDK provides the constant ``\cbdesk\eBaySDK\Sdk::VERSION`` that is set to the current version of the SDK.

.. code-block:: php

    echo cbdesk\eBaySDK\Sdk::VERSION;
...
.. code-block:: php
    ...
    echo cbdesk\eBaySDK\Trading\Services\TradingService::API_VERSION;
