...
.. code-block:: php
    ...
    $finding = new cbdesk\eBaySDK\Finding\Services\FindingService([
        'apiVersion' => '1.13.0',
        'globalId'   => cbdesk\eBaySDK\Constants\GlobalIds::US
    ]);
...
The ``cbdesk\eBaySDK\Sdk`` class can be used as a factory for creating services. Configuration options passed to this class are shared with any services that it creates.
...
.. code-block:: php
    ...
    $sdk = new cbdesk\eBaySDK\Sdk($config);
