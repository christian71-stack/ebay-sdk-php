...
.. code-block:: php
    ...
    <?php
    use \cbdesk\eBaySDK\Browse\Types;

    $request = new Types\GetItemRestRequest();

    /**
     * $response will be of the type cbdesk\eBaySDK\Browse\Types\GetItemRestResponse
     */
...
The SDK provides some support for generating the OAuth tokens needed by the RESTful services. This is provided via the ``\cbdesk\eBaySDK\OAuth\Services\OAuthService`` class.


.. code-block:: php

    use \cbdesk\eBaySDK\OAuth\Services;
    use \cbdesk\eBaySDK\OAuth\Types;
