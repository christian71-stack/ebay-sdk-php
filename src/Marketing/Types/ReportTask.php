 ...
 * @property \cbdesk\eBaySDK\Marketing\Types\Dimension[] $dimensions
 * @property \cbdesk\eBaySDK\Marketing\Types\InventoryReference[] $inventoryReferences
 * @property string[] $listingIds
 * @property \cbdesk\eBaySDK\Marketing\Types\Bas:MarketplaceIdEnum $marketplaceId
 * @property string[] $metricKeys
 * @property string $reportExpirationDate
 * @property \cbdesk\eBaySDK\Marketing\Enums\ReportFormatEnum $reportFormat
 ...
 * @property \cbdesk\eBaySDK\Marketing\Enums\TaskStatusEnum $reportTaskStatus
 * @property string $reportTaskStatusMessage
 * @property \cbdesk\eBaySDK\Marketing\Enums\ReportTypeEnum $reportType
 */
class ReportTask extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'dimensions' => [
            'type' => 'cbdesk\eBaySDK\Marketing\Types\Dimension',
            'repeatable' => true,
            'attribute' => false,
            'elementName' => 'dimensions'
        ],
        'inventoryReferences' => [
            'type' => 'cbdesk\eBaySDK\Marketing\Types\InventoryReference',
            'repeatable' => true,
            'attribute' => false,
        ...
        'marketplaceId' => [
            'type' => 'cbdesk\eBaySDK\Marketing\Types\Bas:MarketplaceIdEnum',
            'repeatable' => false,
            'attribute' => false,
