...
/**
 *
 * @property \cbdesk\eBaySDK\Marketing\Types\Amount $forEachAmount
 * @property integer $forEachQuantity
 * @property \cbdesk\eBaySDK\Marketing\Types\Amount $minAmount
 * @property integer $minQuantity
 * @property integer $numberOfDiscountedItems
 */
class DiscountSpecification extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
