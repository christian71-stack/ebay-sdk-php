 ...
 * @property \cbdesk\eBaySDK\Trading\Enums\ApplicationDeviceTypeCodeType $ApplicationDeviceType
 * @property string $AffiliateUserID
 */
class AffiliateTrackingDetailsType extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
