 ...
 * @property \cbdesk\eBaySDK\Trading\Enums\FeedbackRatingStarCodeType $FeedbackRatingStar
 * @property boolean $IDVerified
 * @property boolean $eBayGoodStanding
 * @property boolean $NewUser
 * @property \cbdesk\eBaySDK\Trading\Types\AddressType $RegistrationAddress
 * @property \DateTime $RegistrationDate
 * @property \cbdesk\eBaySDK\Trading\Enums\SiteCodeType $Site
 * @property \cbdesk\eBaySDK\Trading\Enums\UserStatusCodeType $Status
 * @property string $UserID
 * @property boolean $UserIDChanged
 * @property \DateTime $UserIDLastChanged
 * @property \cbdesk\eBaySDK\Trading\Enums\VATStatusCodeType $VATStatus
 * @property \cbdesk\eBaySDK\Trading\Types\BuyerType $BuyerInfo
 * @property \cbdesk\eBaySDK\Trading\Types\SellerType $SellerInfo
 * @property \cbdesk\eBaySDK\Trading\Enums\BusinessRoleType $BusinessRole
 * @property \cbdesk\eBaySDK\Trading\Enums\PayPalAccountLevelCodeType $PayPalAccountLevel
 * @property \cbdesk\eBaySDK\Trading\Enums\PayPalAccountTypeCodeType $PayPalAccountType
 * @property \cbdesk\eBaySDK\Trading\Enums\PayPalAccountStatusCodeType $PayPalAccountStatus
 * @property \cbdesk\eBaySDK\Trading\Enums\EBaySubscriptionTypeCodeType[] $UserSubscription
 * @property boolean $eBayWikiReadOnly
 * @property integer $TUVLevel
 * @property string $VATID
 * @property boolean $MotorsDealer
 * @property \cbdesk\eBaySDK\Trading\Types\BiddingSummaryType $BiddingSummary
 ...
 * @property \cbdesk\eBaySDK\Trading\Types\MembershipDetailsType $Membership
 * @property string $UserFirstName
 * @property string $UserLastName
 */
class UserType extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'BuyerInfo' => [
            'type' => 'cbdesk\eBaySDK\Trading\Types\BuyerType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'BuyerInfo'
        ],
        'SellerInfo' => [
            'type' => 'cbdesk\eBaySDK\Trading\Types\SellerType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'BiddingSummary' => [
            'type' => 'cbdesk\eBaySDK\Trading\Types\BiddingSummaryType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'Membership' => [
            'type' => 'cbdesk\eBaySDK\Trading\Types\MembershipDetailsType',
            'repeatable' => false,
            'attribute' => false,
