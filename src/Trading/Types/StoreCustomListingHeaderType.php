...
/**
 *
 * @property \cbdesk\eBaySDK\Trading\Enums\StoreCustomListingHeaderDisplayCodeType $DisplayType
 * @property boolean $Logo
 * @property boolean $SearchBox
 * @property \cbdesk\eBaySDK\Trading\Types\StoreCustomListingHeaderLinkType[] $LinkToInclude
 * @property boolean $AddToFavoriteStores
 * @property boolean $SignUpForStoreNewsletter
 */
class StoreCustomListingHeaderType extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'LinkToInclude' => [
            'type' => 'cbdesk\eBaySDK\Trading\Types\StoreCustomListingHeaderLinkType',
            'repeatable' => true,
            'attribute' => false,
