 ...
 * @property \cbdesk\eBaySDK\Trading\Enums\CommentTypeCodeType $CommentType
 * @property string $TransactionID
 * @property string $TargetUser
 * @property \cbdesk\eBaySDK\Trading\Types\ItemRatingDetailArrayType $SellerItemRatingDetailArray
 * @property string $OrderLineItemID
 * @property \cbdesk\eBaySDK\Trading\Enums\ItemArrivedWithinEDDCodeType $ItemArrivedWithinEDDType
 * @property boolean $ItemDeliveredWithinEDD
 */
class LeaveFeedbackRequestType extends \cbdesk\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'SellerItemRatingDetailArray' => [
            'type' => 'cbdesk\eBaySDK\Trading\Types\ItemRatingDetailArrayType',
            'repeatable' => false,
            'attribute' => false,
