 ...
 * @property \cbdesk\eBaySDK\Trading\Enums\ShippingServiceCodeType $ShippingServiceCode
 * @property \cbdesk\eBaySDK\Trading\Enums\ShippingTypeCodeType[] $ServiceType
 ...
 * @property \cbdesk\eBaySDK\Trading\Enums\ShippingCarrierCodeType[] $ShippingCarrier
 * @property boolean $CODService
 * @property \cbdesk\eBaySDK\Trading\Types\AnnouncementMessageType[] $DeprecationDetails
 * @property integer $MappedToShippingServiceID
 * @property string $CostGroupFlat
 * @property \cbdesk\eBaySDK\Trading\Types\ShippingServicePackageDetailsType[] $ShippingServicePackageDetails
 * @property boolean $WeightRequired
 * @property string $DetailVersion
 * @property \DateTime $UpdateTime
 * @property string $ShippingCategory
 */
class ShippingServiceDetailsType extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'DeprecationDetails' => [
            'type' => 'cbdesk\eBaySDK\Trading\Types\AnnouncementMessageType',
            'repeatable' => true,
            'attribute' => false,
        ...
        'ShippingServicePackageDetails' => [
            'type' => 'cbdesk\eBaySDK\Trading\Types\ShippingServicePackageDetailsType',
            'repeatable' => true,
            'attribute' => false,
