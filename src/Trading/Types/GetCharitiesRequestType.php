 ...
 * @property \cbdesk\eBaySDK\Trading\Enums\StringMatchCodeType $MatchType
 * @property boolean $Featured
 */
class GetCharitiesRequestType extends \cbdesk\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
