...
/**
 *
 * @property \cbdesk\eBaySDK\Trading\Enums\BidActionCodeType $Action
 * @property \cbdesk\eBaySDK\Trading\Enums\CurrencyCodeType $Currency
 * @property \cbdesk\eBaySDK\Trading\Types\AmountType $MaxBid
 * @property integer $Quantity
 * @property boolean $SecondChanceEnabled
 * @property \cbdesk\eBaySDK\Trading\Enums\CurrencyCodeType $SiteCurrency
 * @property \DateTime $TimeBid
 * @property \cbdesk\eBaySDK\Trading\Types\AmountType $HighestBid
 * @property \cbdesk\eBaySDK\Trading\Types\AmountType $ConvertedPrice
 * @property \cbdesk\eBaySDK\Trading\Types\UserType $User
 * @property boolean $UserConsent
 * @property string $Message
 * @property string $BestOfferID
 * @property \cbdesk\eBaySDK\Trading\Types\AmountType $MyMaxBid
 */
class OfferType extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
