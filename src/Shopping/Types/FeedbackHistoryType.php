...
/**
 *
 * @property \cbdesk\eBaySDK\Shopping\Types\FeedbackPeriodType[] $BidRetractionFeedbackPeriods
 * @property \cbdesk\eBaySDK\Shopping\Types\FeedbackPeriodType[] $NegativeFeedbackPeriods
 * @property \cbdesk\eBaySDK\Shopping\Types\FeedbackPeriodType[] $NeutralFeedbackPeriods
 * @property \cbdesk\eBaySDK\Shopping\Types\FeedbackPeriodType[] $PositiveFeedbackPeriods
 * @property \cbdesk\eBaySDK\Shopping\Types\FeedbackPeriodType[] $TotalFeedbackPeriods
 * @property integer $UniqueNegativeFeedbackCount
 * @property integer $UniquePositiveFeedbackCount
 * @property \cbdesk\eBaySDK\Shopping\Types\AverageRatingDetailsType[] $AverageRatingDetails
 * @property integer $NeutralCommentCountFromSuspendedUsers
 * @property integer $UniqueNeutralFeedbackCount
 */
class FeedbackHistoryType extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        'BidRetractionFeedbackPeriods' => [
            'type' => 'cbdesk\eBaySDK\Shopping\Types\FeedbackPeriodType',
            'repeatable' => true,
            'attribute' => false,
        ...
        'AverageRatingDetails' => [
            'type' => 'cbdesk\eBaySDK\Shopping\Types\AverageRatingDetailsType',
            'repeatable' => true,
            'attribute' => false,
