 ...
 * @property \cbdesk\eBaySDK\Shopping\Enums\ProductSortCodeType $ProductSort
 * @property \cbdesk\eBaySDK\Shopping\Enums\SortOrderCodeType $SortOrder
 * @property integer $MaxEntries
 * @property integer $PageNumber
 * @property string $CategoryID
 * @property boolean $HideDuplicateItems
 */
class FindProductsRequestType extends \cbdesk\eBaySDK\Shopping\Types\AbstractRequestType
{
    /**
