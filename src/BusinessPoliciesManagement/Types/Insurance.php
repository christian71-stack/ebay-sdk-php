...
/**
 *
 * @property \cbdesk\eBaySDK\BusinessPoliciesManagement\Types\Amount $domesticInsuranceFee
 * @property string $domesticInsuranceOption
 * @property string $intlInsuranceOption
 * @property \cbdesk\eBaySDK\BusinessPoliciesManagement\Types\Amount $intlInsuranceFee
 */
class Insurance extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
