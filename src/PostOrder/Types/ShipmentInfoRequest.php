 ...
 * @property \cbdesk\eBaySDK\PostOrder\Types\Text $sellerComments
 * @property boolean $shippedWithTracking
 * @property string $shippingCarrierName
 * @property \cbdesk\eBaySDK\PostOrder\Types\DateTime $shippingDate
 * @property string $trackingNumber
 */
class ShipmentInfoRequest extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
