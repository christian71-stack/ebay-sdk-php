 ...
 * @property \cbdesk\eBaySDK\PostOrder\Enums\AddressTypeEnum $addressType
 * @property string $city
 * @property \cbdesk\eBaySDK\PostOrder\Enums\CountryCodeEnum $country
 * @property string $county
 * @property boolean $isTransliterated
 * @property string $nationalRegion
 * @property string $postalCode
 * @property \cbdesk\eBaySDK\PostOrder\Enums\LanguageScriptEnum $script
 * @property string $stateOrProvince
 * @property \cbdesk\eBaySDK\PostOrder\Enums\LanguageScriptEnum $transliteratedFromScript
 * @property \cbdesk\eBaySDK\PostOrder\Enums\WorldRegionEnum $worldRegion
 */
