...
/**
 *
 * @property \cbdesk\eBaySDK\PostOrder\Types\DateTime $actionDate
 * @property string $activityParty
 * @property \cbdesk\eBaySDK\PostOrder\Enums\CancelActivityTypeEnum $activityType
 * @property string $cancelStateFrom
 * @property string $cancelStateTo
 * @property string $cancelStatetateTo
 */
class CancelActivityHistory extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
