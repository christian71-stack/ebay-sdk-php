 ...
 */
class FulfillmentBaseService extends \cbdesk\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \cbdesk\eBaySDK\Fulfillment\Services\FulfillmentService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
