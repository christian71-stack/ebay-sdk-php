 ...
 * @property \cbdesk\eBaySDK\Fulfillment\Types\Amount $holdAmount
 * @property string $holdReason
 * @property string $holdState
 * @property string $releaseDate
 * @property \cbdesk\eBaySDK\Fulfillment\Types\SellerActionsToRelease[] $sellerActionsToRelease
 */
class PaymentHold extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'sellerActionsToRelease' => [
            'type' => 'cbdesk\eBaySDK\Fulfillment\Types\SellerActionsToRelease',
            'repeatable' => true,
            'attribute' => false,
