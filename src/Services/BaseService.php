<?php
namespace cbdesk\eBaySDK\Services;

use cbdesk\eBaySDK\Parser\XmlParser;
...
abstract class BaseService
{
     ...
     */
    protected function callOperationAsync($name, \cbdesk\eBaySDK\Types\BaseType $request, $responseClass)
    {
        $url = $this->getUrl();
     ...
     */
    protected function buildRequestBody(\cbdesk\eBaySDK\Types\BaseType $request)
    {
     ...
     */
    private function buildXopDocument(\cbdesk\eBaySDK\Types\BaseType $request)
    {
        return sprintf(
            '%s%s%s%s%s',
     ...
     */
    protected function buildMultipartFormDataXMLPayload(\cbdesk\eBaySDK\Types\BaseType $request)
    {
        return sprintf(
            '%s%s%s',
            '--boundary'.self::CRLF,
