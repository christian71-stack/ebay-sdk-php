...
/**
 *
 * @property \cbdesk\eBaySDK\Account\Types\Amount $maxSoldInventoryValue
 * @property integer $maxSoldQuantity
 * @property \cbdesk\eBaySDK\Account\Types\Amount $minSoldInventoryValue
 * @property integer $minSoldQuantity
 * @property \cbdesk\eBaySDK\Account\Types\TimeDuration $period
 */
class SoldAggregatedMetrics extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
