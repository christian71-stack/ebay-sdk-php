 ...
 * @property \cbdesk\eBaySDK\Account\Enums\RefundMethodEnum $refundMethod
 * @property string $restockingFeePercentage
 * @property string $returnInstructions
 * @property \cbdesk\eBaySDK\Account\Enums\ReturnMethodEnum $returnMethod
 * @property \cbdesk\eBaySDK\Account\Types\TimeDuration $returnPeriod
 * @property string $returnPolicyId
 * @property boolean $returnsAccepted
 * @property \cbdesk\eBaySDK\Account\Enums\ReturnShippingCostPayerEnum $returnShippingCostPayer
 * @property \cbdesk\eBaySDK\Account\Types\ErrorDetailV3[] $warnings
 */
class SetReturnPolicyResponse extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'warnings' => [
            'type' => 'cbdesk\eBaySDK\Account\Types\ErrorDetailV3',
            'repeatable' => true,
            'attribute' => false,
