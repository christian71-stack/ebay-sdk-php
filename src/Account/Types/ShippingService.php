...
/**
 *
 * @property \cbdesk\eBaySDK\Account\Types\Amount $additionalShippingCost
 * @property boolean $buyerResponsibleForPickup
 * @property boolean $buyerResponsibleForShipping
 * @property \cbdesk\eBaySDK\Account\Types\Amount $cashOnDeliveryFee
 * @property boolean $freeShipping
 * @property string $shippingCarrierCode
 * @property \cbdesk\eBaySDK\Account\Types\Amount $shippingCost
 * @property string $shippingServiceCode
 * @property \cbdesk\eBaySDK\Account\Types\RegionSet $shipToLocations
 * @property integer $sortOrder
 * @property \cbdesk\eBaySDK\Account\Types\Amount $surcharge
 */
class ShippingService extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
