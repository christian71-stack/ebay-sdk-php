 ...
 * @property \cbdesk\eBaySDK\Catalog\Enums\ChangeRequestStatus $changeRequestStatus
 * @property \cbdesk\eBaySDK\Catalog\Enums\ChangeRequestType $changeRequestType
 * @property string $creationDate
 * @property string $expectedCompletionDate
 * @property \cbdesk\eBaySDK\Catalog\Types\ProcessResolution $processResolution
 * @property string $processStatusMessage
 * @property string $reasonForChangeRequest
 * @property string $referenceId
 * @property \cbdesk\eBaySDK\Catalog\Enums\ReferenceType $referenceType
 * @property string $resolutionDate
 * @property \cbdesk\eBaySDK\Catalog\Types\SuggestedProduct $suggestedProduct
 */
class ChangeRequest extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'processResolution' => [
            'type' => 'cbdesk\eBaySDK\Catalog\Types\ProcessResolution',
            'repeatable' => false,
            'attribute' => false,
        ...
        'suggestedProduct' => [
            'type' => 'cbdesk\eBaySDK\Catalog\Types\SuggestedProduct',
            'repeatable' => false,
            'attribute' => false,
