<?php
namespace cbdesk\eBaySDK\Analytics\Services;

/**
 * Base class for the Analytics service.
 */
class AnalyticsBaseService extends \cbdesk\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \cbdesk\eBaySDK\Analytics\Services\AnalyticsService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
