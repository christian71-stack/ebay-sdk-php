<?php
namespace cbdesk\eBaySDK\OAuth\Services;

use cbdesk\eBaySDK\ConfigurationResolver;
use cbdesk\eBaySDK\Credentials\CredentialsProvider;
use cbdesk\eBaySDK\UriResolver;
use \cbdesk\eBaySDK as Functions;
...
class OAuthService
{
    ...
    private static $operations = [
        'getUserToken' => [
            ...
            'responseClass' => '\cbdesk\eBaySDK\OAuth\Types\GetUserTokenRestResponse',
            'params' => [
            ]
        ],
        'refreshUserToken' => [
            'method' => 'POST',
            'resource' => 'oauth2/token',
            'responseClass' => '\cbdesk\eBaySDK\OAuth\Types\RefreshUserTokenRestResponse',
            'params' => [
            ]
        ],
        'getAppToken' => [
            'method' => 'POST',
            'resource' => 'oauth2/token',
            'responseClass' => '\cbdesk\eBaySDK\OAuth\Types\GetAppTokenRestResponse',
            'params' => [
            ]
        ]
    ];
    ...
    /**
     * @var \cbdesk\eBaySDK\ConfigurationResolver Resolves configuration options.
     */
    private $resolver;

    /**
     * @var \cbdesk\eBaySDK\UriResolver Resolves uri parameters.
     */
    private $uriResolver;
    ...
    public static function getConfigDefinitions()
    {
        return [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \cbdesk\eBaySDK\OAuth\Services\OAuthService::API_VERSION,
                'required' => true
            ],
            'profile' => [
                'valid' => ['string'],
                'fn'    => 'cbdesk\eBaySDK\applyProfile',
            ],
            'credentials' => [
                'valid'   => ['cbdesk\eBaySDK\Credentials\CredentialsInterface', 'array', 'callable'],
                'fn'      => 'cbdesk\eBaySDK\applyCredentials',
                'default' => [CredentialsProvider::class, 'defaultProvider']
            ],
            'debug' => [
                'valid'   => ['bool', 'array'],
                'fn'      => 'cbdesk\eBaySDK\applyDebug',
                'default' => false
            ],
            'httpHandler' => [
                'valid'   => ['callable'],
                'default' => 'cbdesk\eBaySDK\defaultHttpHandler'
            ],
            'httpOptions' => [
                'valid'   => ['array'],
                'default' => [
     ...
     *
     * @return \cbdesk\eBaySDK\Credentials\CredentialsInterface
     */
    ...
    /**
     * @param \cbdesk\eBaySDK\OAuth\Types\GetUserTokenRestRequest $request
     * @return \cbdesk\eBaySDK\OAuth\Types\GetUserTokenRestResponse
     */
    public function getUserToken(\cbdesk\eBaySDK\OAuth\Types\GetUserTokenRestRequest $request)
    {
     ...
     */
    public function getUserTokenAsync(\cbdesk\eBaySDK\OAuth\Types\GetUserTokenRestRequest $request)
    {
        if (!$request) {
            $request = new \cbdesk\eBaySDK\OAuth\Types\GetUserTokenRestRequest();
        }
    ...
    /**
     * @param \cbdesk\eBaySDK\OAuth\Types\RefreshUserTokenRestRequest $request
     * @return \cbdesk\eBaySDK\OAuth\Types\RefreshUserTokenRestResponse
     */
    public function refreshUserToken(\cbdesk\eBaySDK\OAuth\Types\RefreshUserTokenRestRequest $request)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refreshUserTokenAsync(\cbdesk\eBaySDK\OAuth\Types\refreshUserTokenRestRequest $request)
    {
        if (!$request) {
            $request = new \cbdesk\eBaySDK\OAuth\Types\RefreshUserTokenRestRequest();
        }
        if (!isset($request->grant_type)) {
    ...
    /**
     * @param \cbdesk\eBaySDK\OAuth\Types\GetAppTokenRestRequest $request
     * @return \cbdesk\eBaySDK\OAuth\Types\GetAppTokenRestResponse
     */
    public function getAppToken(\cbdesk\eBaySDK\OAuth\Types\GetAppTokenRestRequest $request = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAppTokenAsync(\cbdesk\eBaySDK\OAuth\Types\GetAppTokenRestRequest $request = null)
    {
        if (!$request) {
            $request = new \cbdesk\eBaySDK\OAuth\Types\GetAppTokenRestRequest();
        }
        if (!isset($request->grant_type)) {
     ...
     * @param \cbdesk\eBaySDK\Types\BaseType $request Request object containing the request information.
     *
     * @return \GuzzleHttp\Promise\PromiseInterface A promise that will be resolved with an object created from the JSON response.
     */
    private function callOperationAsync($name, \cbdesk\eBaySDK\Types\BaseType $request = null)
    {
