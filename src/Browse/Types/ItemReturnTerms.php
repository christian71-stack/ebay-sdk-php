 ...
 * @property \cbdesk\eBaySDK\Browse\Enums\RefundMethodEnum $refundMethod
 * @property string $restockingFeePercentage
 * @property string $returnInstructions
 * @property \cbdesk\eBaySDK\Browse\Enums\ReturnMethodEnum $returnMethod
 * @property \cbdesk\eBaySDK\Browse\Types\TimeDuration $returnPeriod
 * @property boolean $returnsAccepted
 * @property \cbdesk\eBaySDK\Browse\Enums\ReturnShippingCostPayerEnum $returnShippingCostPayer
 */
class ItemReturnTerms extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'returnPeriod' => [
            'type' => 'cbdesk\eBaySDK\Browse\Types\TimeDuration',
            'repeatable' => false,
            'attribute' => false,
