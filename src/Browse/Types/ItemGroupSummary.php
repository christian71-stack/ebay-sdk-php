...
/**
 *
 * @property \cbdesk\eBaySDK\Browse\Types\Image[] $itemGroupAdditionalImages
 * @property string $itemGroupHref
 * @property string $itemGroupId
 * @property \cbdesk\eBaySDK\Browse\Types\Image $itemGroupImage
 * @property string $itemGroupTitle
 * @property \cbdesk\eBaySDK\Browse\Enums\ItemGroupTypeEnum $itemGroupType
 */
class ItemGroupSummary extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
