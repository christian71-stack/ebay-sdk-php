 ...
 * @property \cbdesk\eBaySDK\Finding\Types\Amount $buyItNowPrice
 * @property \cbdesk\eBaySDK\Finding\Types\Amount $convertedBuyItNowPrice
 * @property \DateTime $startTime
 * @property \DateTime $endTime
 * @property string $listingType
 * @property boolean $gift
 */
class ListingInfo extends \cbdesk\eBaySDK\Types\BaseType
{
    /**
