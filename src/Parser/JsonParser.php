...
{
    /**
     * @param mixed A PHP object derived from cbdesk\eBaySDK\Types\BaseType
    ...
    private static function assignProperties(\cbdesk\eBaySDK\Types\BaseType $object, array $properties)
    {
