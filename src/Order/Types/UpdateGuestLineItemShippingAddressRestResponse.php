...
/**
 *
 * @property \cbdesk\eBaySDK\Order\Types\ErrorDetailV3[] $errors
 * @property \cbdesk\eBaySDK\Order\Types\ErrorDetailV3[] $warnings
 */
class UpdateGuestLineItemShippingAddressRestResponse extends \cbdesk\eBaySDK\Order\Types\CheckoutSessionResponse
{
    use StatusCodeTrait;
