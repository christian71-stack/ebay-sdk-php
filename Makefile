...
sync_file:
	...
	sed -i -e "s/@property string/@property \\\cbdesk\\\eBaySDK\\\FileTransfer\\\Types\\\Data/" src/FileTransfer/Types/FileAttachment.php
	sed -i -e "s/'string'/'cbdesk\\\eBaySDK\\\FileTransfer\\\Types\\\Data'/" src/FileTransfer/Types/FileAttachment.php
